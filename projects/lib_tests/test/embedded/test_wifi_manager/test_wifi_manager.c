...
void test_if_wifi_manager_store_ap_returns_err_on_null_ssid(void) {
	...
	ERR_C_NULL_POINTER, err,
	"wifi_manager_store_ap should return err on NULL ssid");
}
...
void test_if_wifi_manager_store_ap_returns_err_on_null_pass(void) {
    ...
    TEST_ASSERT_EQUAL_MESSAGE(
	ERR_C_NULL_POINTER, err,
	"wifi_manager_store_ap should return err on NULL password");
}
...
void test_if_wifi_manager_store_ap_returns_zero(void) {
    ...
    // then
    TEST_ASSERT_EQUAL_MESSAGE(ERR_C_OK, err,
			      "wifi_manager_store_ap should return ERR_C_OK");
}
...
void test_if_wifi_manager_get_stored_ap_returns_err_on_null_ssid(void) {
    ...
    TEST_ASSERT_EQUAL_MESSAGE(
	ERR_C_NULL_POINTER, err,
	"wifi_manager_get_stored_ap should return err on NULL ssid");
}
...
void test_if_wifi_manager_get_stored_ap_returns_err_on_null_pass(void) {
    ...
    TEST_ASSERT_EQUAL_MESSAGE(
	ERR_C_NULL_POINTER, err,
	"wifi_manager_get_stored_ap should return err on NULL password");
}
...
void test_if_wifi_manager_get_stored_ap_returns_zero(void) {
    ...
    // then
    TEST_ASSERT_EQUAL_MESSAGE(
	ERR_C_OK, err, "wifi_manager_get_stored_ap should return ERR_C_OK");
}
...
void test_if_wifi_manager_gets_stored_ap_ssid(void) {
    ...
    // when
    wifi_manager_store_ap(exp_ssid, strlen(exp_ssid), exp_pass,
			  strlen(exp_pass));
    wifi_manager_get_stored_ap(ssid, sizeof(ssid), pass, sizeof(pass));

    // then
    TEST_ASSERT_EQUAL_STRING_MESSAGE(exp_ssid, ssid,
				     "stored ssid different from expected");
}
...
void test_if_wifi_manager_gets_stored_ap_pass(void) {
    ...
    // then
    TEST_ASSERT_EQUAL_STRING_MESSAGE(exp_pass, pass,
				     "stored pass different from expected");
}
...
int runUnityTests(void) {
    ...
    RUN_TEST(
	test_if_wifi_manager_get_stored_ap_returns_err_on_not_init_nvs_partition);
    ...
    RUN_TEST(
	test_if_wifi_manager_store_ap_returns_err_on_not_init_nvs_partition);
