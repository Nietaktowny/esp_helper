...
def create_new_lib(lib_name, lib_description):
    src_dir = "src"
    include_dir = "include"
    ...
    os.chdir('/home/wmytych/Projects/esp_helper/libraries/')
...
description = input("Enter library description: ")
create_new_lib(name, description)